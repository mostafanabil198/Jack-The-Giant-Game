...
public class HighScore implements Screen {
    ...
    private Texture bg;
    private HighScoreBtns btns;

    public HighScore(GameMain game) {
        GameManager.getInstance().screen = 3;
        GameManager.getInstance().screenObj = (HighScore) this;
        this.game = game;
